    ...
    >
        ...
        <div class="flex container mx-auto items-center h-full">
            <div class="flex w-1/3 flex-col items-start">
                <h1 class="font-bold text-white text-5xl leading-tight mb-4">Simple generic landing page to subscribe</h1>
                <p class="text-indigo-200 text-xl mb-10">
                    We are just checking the <span class="font-bold underline">TALL</span> stack. Would you like subscribing?
                </p>
                <x-button 
        ...
        <x-modal trigger="showSubscribe" class="bg-pink-500">
            ...
            >
                ...
                ></x-input>
                <span class="py-1 text-gray-100 text-xs">
                    {{
                        $errors->has('email')
                        ? $errors->first('email')
