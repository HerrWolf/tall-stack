<div class="p-6 bg-white border-b border-gray-200">
    ...
    <div class="px-8">
        <x-input
            type="text"
            class="rounded-lg border float-right border-gray-300 mb-4 w-1/3"
            placeholder="Search"
            wire:model="search"
        ></x-input>
        @if($subscribers->isEmpty())
            <div class="flex w-full bg-red-100 p-5 rounded-lg">
                <p class="text-red-400 mx-auto">No subscribers found.</p>
            </div>
        @else
            <table class="w-full">
                <thead
                ...
                <tbody>
                    @foreach($subscribers as $subscriber)
                        <tr class="text-sm text-indigo-900 border-b border-gray-400">
                            ...
                            <td class="px-6 py-4">
                                <x-button 
                                class="border-red-500 text-red-500 bg-red-50 hover:bg-red-100"
